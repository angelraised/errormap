  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content">
        ...
        {screen === 'diagnostic' && account?.role === 'student' && activeSubject && <DiagnosticView profile={profile} account={account} language={language} subject={activeSubject} onCancel={() => setScreen('subject')} onComplete={updated => { setProfile(updated); setScreen('results'); }} />}
